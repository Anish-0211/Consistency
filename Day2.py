...
class Window(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        twitter.triggered.connect(lambda: self.go_to_URL(
            QUrl("https://www.twitter.com")))
